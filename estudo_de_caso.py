...
Original file is located at
    https://colab.research.google.com/drive/1Sivjj9ibURMw00CBE3h2UdpsxBEmkPWa
"""
...
class Aluno(Pessoa):
    ...
    def cadastrarAluno(self):
        ...
        try:
            pd.read_csv('Alunos.csv')
        except FileNotFoundError:
            df.to_csv('Alunos.csv', header = True, index = False, sep = ',')
        else:
...
class Matricula(Aluno):
    ...
    def matricular(self):
        ...
        try:
            pd.read_csv('Matriculas.csv')
        except FileNotFoundError:
            df.to_csv('Matriculas.csv', header = True, index = False, sep = ',')
        else:
            df.to_csv('Matriculas.csv', header = False, index = False, sep = ',', mode = 'a')
...
class Professor(Funcionario):
    ...
    def cadastrarProfessor(self):
        ...
        try:
            pd.read_csv('Professores.csv')
        except FileNotFoundError:
            df.to_csv('Professores.csv', header=True, index=False, sep=',')
        else:
            df.to_csv('Professores.csv', header=False, index=False, sep=',', mode='a')
...
class Coordenador(Professor):
    ...
    def cadastrarCoordenador(self):
        ...
        try:
            pd.read_csv('Coordenadores.csv')
        except FileNotFoundError:
            df.to_csv('Coordenadores.csv', header=True, index=False, sep=',')
        else:
            df.to_csv('Coordenadores.csv', header=False, index=False, sep=',', mode='a')
...
class CoordenadorAdm(Funcionario):
    ...
    def cadastrarCoordenadorAdm(self):
        ...
        try:
            pd.read_csv('CoordenadoresAdm.csv')
        except FileNotFoundError:
            df.to_csv('CoordenadoresAdm.csv', header=True, index=False, sep=',')
        else:
            df.to_csv('CoordenadoresAdm.csv', header=False, index=False, sep=',', mode='a')
...
class Curso:
    ...
    def cadastrarCurso(self):
        ...
        try:
            pd.read_csv('Cursos.csv')
        except:
            df.to_csv('Cursos.csv', header=True, index=False, sep=',')
        else:
            df.to_csv('Cursos.csv', header=False, index=False, sep=',', mode='a')
    ...
    def calcularNumMinAluno(self):
        try:
            folhaSalarial = pd.read_csv('FolhaSalarial.csv')
